# DNC-BoardTasks-Back
Projeto em Express.js do BoardTasks Back-End feito para o curso da escola DNC.
...
5) Depois entre na documentação da API é só acessar em seu navegador o endereço ```http://localhost:4000/```# DNC-BoardTask-BackEnd